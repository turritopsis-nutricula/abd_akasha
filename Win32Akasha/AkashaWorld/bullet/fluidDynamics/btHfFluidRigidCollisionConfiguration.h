...
#define USE_BUOYANT_CONCAVE_ALGORITHM 1
...
class	btHfFluidRigidCollisionConfiguration : public btDefaultCollisionConfiguration
{
	...
	btCollisionAlgorithmCreateFunc* m_fluidCreateFunc;
	btCollisionAlgorithmCreateFunc* m_swappedFluidCreateFunc;
	...
	btCollisionAlgorithmCreateFunc* m_hfFluidBuoyantConcaveCollisionCreateFunc;
	btCollisionAlgorithmCreateFunc* m_swappedHfFluidBuoyantConcaveCollisionCreateFunc;
	btCollisionAlgorithmCreateFunc* m_hfFluidBuoyantConvexCollisionCreateFunc;
	btCollisionAlgorithmCreateFunc* m_swappedHfFluidBuoyantConvexCollisionCreateFunc;
